...
<body>
    ...
    <?php
	  ...
	  $sql="select * from college_course where clg_course_id='$id'";
	  $res=mysql_query($sql);
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form"  method="post" action="/table_update/update_college_course.php" role="form" style="display: block;">
                                    <input type="hidden" name="clg_course_id" id="hiddenField" value="<?php echo $row['clg_course_id']; ?>">
                                    <label>Course ID </label>
									<div class="form-group">
										<input type="text" name="course_id" id="email" tabindex="1" class="form-control" placeholder="Course ID" required value="<?php echo $row['course_id'];?>">
									</div>
