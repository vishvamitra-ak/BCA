    ...
    <tr>
	  ...
	  while($row=mysql_fetch_array($res))
	  {
	  	...
	  	<tr>
            ...
            <td><a class="ed_btn" href="/table_edit/edit_course.php?id=<?php echo $row[course_id];?>">EDIT</a></td>
			<td><a class="del_btn" onClick="return confirm('Are you sure?');" href="/table_delete/delete_course.php?id=<?php echo $row[course_id];?>">DELETE</a></td>
