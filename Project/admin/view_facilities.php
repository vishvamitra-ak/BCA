...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Facilities  <a class="ins_btn" href="insert_facilities.php?id=<?php echo $id; ?>">INSERT</a></h1>
			</div>
		</div><!--/.row-->
...
<table width="1427" height="73" class="table table bordered" id="sample_1">
  <thead class="thead-dark">
    ...
    <tbody>
	  ...
	  $sql="select * from facilities f,college c where f.clg_id=c.clg_id and c.clg_id='$id'";
	  $res=mysql_query($sql);
	  while($row=mysql_fetch_array($res))
	  {
	  	...
	  	<tr>
            ...
            <td><a class="ed_btn" href="edit_facilities.php?id=<?php echo $row[fac_id];?>">EDIT</a></td>
