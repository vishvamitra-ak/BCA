			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form"  method="post" action="insert_admissionp.php" role="form" style="display: block;">
                                    <label>Student</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
	                                           ...
	                                           $sql="select * from student s,login l where s.email=l.username";
	                                           $res=mysql_query($sql);
                                    ...
                                    <label>Course</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
	                                           ...
	                                           $con=mysql_connect('localhost','root','xyzzy');
	                                           mysql_select_db('project_test',$con);
	                                           $sql="select * from college c, login l,course cc where c.clg_email=l.username and c.clg_id='$id' and cc.clg_id=c.clg_id";
	                                           $res=mysql_query($sql);
	                                           while($row1=mysql_fetch_array($res))
	                                           {
		                                           ?>
                                            <option value="<?php echo $row1['course_id'];?>"><?php echo $row1['course_name'];?> (<?php echo $row1['clg_name'];?>)</option>
                                                <?php
                                                    }
                                                    ?>
                                        </select>
                                    ...
                                    <div class="form-group">
										<select class="form-control" id="sel1" name="upload_details">
