...
<body>
    ...
    <?php
	  ...
	  $sql="select * from student s,marks m where s.stud_id='$id' and m.stud_id=s.stud_id";
	  $res=mysql_query($sql);
						...
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form"  method="post" action="update_student.php" role="form" style="display: block;">
                                    ...
                                    <label>E Mail</label>
                                    <div class="form-group">
										<input disabled type="text" name="email" id="email" tabindex="1" class="form-control" placeholder="E Mail" required value="<?php echo $row['email'];?>">
									</div>
                                    <label>Contact</label>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
										<input type="text" name="sslc_year" id="email" tabindex="1" class="form-control" placeholder="Year" required value="<?php echo $row['sslc_year'];?>">
									</div>
									<div class="form-group">
										<input type="text" name="sslc_per" id="email" tabindex="1" class="form-control" placeholder="Score" required value="<?php echo $row['sslc_per'];?>">
									</div>
									<label>Class XII Details</label>
									<div class="form-group">
										<input type="text" name="puc_year" id="email" tabindex="1" class="form-control" placeholder="Year" required value="<?php echo $row['puc_year'];?>">
									</div>
									<div class="form-group">
										<input type="text" name="puc_per" id="email" tabindex="1" class="form-control" placeholder="Score" required value="<?php echo $row['puc_per'];?>">
									</div>
									<div class="form-group">
										<div class="row">
