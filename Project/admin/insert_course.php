			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form"  method="post" action="insert_coursep.php" role="form" style="display: block;">
								<input name="clg_id" type=hidden value="<?php echo $id; ?>">
									...
									<label>Fees</label>
                                    <div class="form-group">
										<input type="text" name="fees" id="email" tabindex="1" class="form-control" placeholder="Fees" required>
									</div>
									<div class="form-group">
										<div class="row">
