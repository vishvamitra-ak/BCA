...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Course <a class="ins_btn" href="insert_course.php">Add New</a></h1>
			</div>
		</div><!--/.row-->
...
<table width="1427" height="73" class="table table-bordered" id="sample_1">
  <thead class="thead-dark">
    ...
    <tbody>
	  ...
	  $sql="select * from course c,college clg where clg.clg_id=c.clg_id and clg.clg_email='$uname'";
	  $res=mysql_query($sql);
