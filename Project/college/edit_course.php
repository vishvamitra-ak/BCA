...
<?php include('include/link.php');
    ...
    <?php
	  ...
	  $sql1="select * from college where clg_email='$uname'";
						...
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form"  method="post" action="update_course.php" role="form" style="display: block;">
									...
									<input type="hidden" name="clg_id" id="hiddenField" value="<?php echo $row1['clg_id']; ?>">
									...
									<label>Fees</label>
                                    <div class="form-group">
										<input type="text" name="fees" id="email" tabindex="1" class="form-control" placeholder="Fees" required value="<?php echo $row['fees'];?>">
									</div>
									<div class="form-group">
										<div class="row">
