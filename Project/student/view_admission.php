...
<table width="1427" height="73" class="table table-bordered" id="sample_1">
    ...
    <tr>
	  ...
	  <th width="71" scope="col">Course</th>
    ...
    <tbody>
	  ...
	  $sql="select * from admission a, course c, college clg,student s where a.course_id=c.course_id and c.clg_id=clg.clg_id and a.stud_id=s.stud_id and s.email='$uname'";
	  $res=mysql_query($sql);
