...
<table width="1427" height="73" class="table" id="sample_1">
  <thead class="thead-dark">
    <tr>
	  ...
	  <th width="173" scope="col">Details</th>
    ...
    <tbody>
	  ...
	  while($row=mysql_fetch_array($res))
	  {
	  	...
	  	<tr>
			 ...
			 <td><p><strong><a class="" href="view_course.php?id=<?php echo $row[clg_id];?>">Courses</a></strong></p>
				<p><strong><a class="" href="view_facilities.php?id=<?php echo $row[clg_id];?>">Facilities</a></strong></p>
				<p><strong><a class="" href="view_events.php?id=<?php echo $row[clg_id];?>">Events</a></strong></p>
			 </td>
