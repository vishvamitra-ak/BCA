	  ...
	  ?>
		...
		<ul class="nav menu">
           ...
           <!-- <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
			...
			<li><a href="view_admission.php"><em class="fa fa-clone">&nbsp;</em> Application Status</a></li>
			<li><a href="edit_student.php?id=<?php echo $uname;?>"><em class="fa fa-clone">&nbsp;</em> Edit Profile</a></li>
