...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="/student/index.php"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a></li>
            ...
            <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
				...
				<ul class="children collapse" id="sub-item-2">
					<li><a class="" href="/student/view_admission.php">
						<span class="fa fa-arrow-right">&nbsp;</span> Admission
					</a></li>
					<li><a class="" href="/student/view_college.php">
						<span class="fa fa-arrow-right">&nbsp;</span> College
					</a></li>
					<li><a class="" href="/student/view_college_course.php">
						<span class="fa fa-arrow-right">&nbsp;</span> College_Course
					</a></li>
                    <li><a class="" href="/student/view_course.php">
						<span class="fa fa-arrow-right">&nbsp;</span> Course
					</a></li>
                    <li><a class="" href="/student/view_events.php">
						<span class="fa fa-arrow-right">&nbsp;</span> Events
					</a></li>
                    <li><a class="" href="/student/view_facilities.php">
						<span class="fa fa-arrow-right">&nbsp;</span> Facilities
					</a></li>
                    <li><a class="" href="/student/view_marks.php">
						<span class="fa fa-arrow-right">&nbsp;</span> Marks
					</a></li>
                    <li><a class="" href="/student/view_student.php">
