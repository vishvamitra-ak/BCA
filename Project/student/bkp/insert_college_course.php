			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form"  method="post" action="/admin/insert_college_coursep.php" role="form" style="display: block;">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <select class="form-control" id="sel1" name="clg_id">
									...
									<div class="form-group">
										<input type="text" name="course_id" id="email" tabindex="1" class="form-control" placeholder="Course ID" required>
									</div>
									<div class="form-group">
										<div class="row">
