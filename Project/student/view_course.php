...
<table width="1427" height="73" class="table" id="sample_1">
  <thead class="thead-dark">
    <tr>
	  ...
	  <th width="209" scope="col">Course</th>
      <th width="71" scope="col">Description</th>
	  <th width="71" scope="col">Fees</th>
    ...
    <tbody>
	  ...
	  $sql="select * from course c,college clg where c.clg_id='$id' and c.clg_id=clg.clg_id";
	  $res=mysql_query($sql);
	  while($row=mysql_fetch_array($res))
	  {
	  	...
	  	<tr>
            ...
            <td><a class="ed_btn" href="insert_admissionp.php?id=<?php echo $row[course_id];?>">Apply</a></td>
